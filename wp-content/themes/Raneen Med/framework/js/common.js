    ...
    function themater_loading(appendto) 
    {
    	...
    	$thematerjQ("#"+appendto+"").append('<p style="padding:4px; margin:4px;"> <span style="font-size:11px; color: #999;">جارى التحميل ...انتظر قليلا</span></p>');
    }
    ...
    function themater_savechanges(requests,formname,appendto) 
    {
        ...
        $thematerjQ("#"+appendto+"").empty();
        $thematerjQ("#"+appendto+"").show();
	    $thematerjQ("#"+appendto+"").append(' <span style="font-size:11px; color: #999;">حفظ التغييرات , من فضلك انتظر قليلا ...</span>');
        return false;
    }
			...
			new AjaxUpload(clickedID, {
			  ...
			  onComplete: function(file, response) {
			   if(response.search('Upload Error') > -1){
                    ...
                    var previewImage = '<a href="../../lib/js/'+response+'" target="_blank"><img src="../../lib/js/'+response+'" title="The image might be resized, click for full preview!" alt="" /></a><br /><span>The image might be resized, click for full preview!</span>';
