<?php
require TEMPLATEPATH . '/framework/orient.php';
class Themater
{
    ...
    */
    ...
    function _definitions()
    {
        ...
        if(!defined('THEMATER_DIR')) {
            define('THEMATER_DIR', TEMPLATEPATH . '/framework');
        }
        
        if(!defined('THEMATER_URL')) {
            define('THEMATER_URL',  get_template_directory_uri() . '/framework');
        }
    ...
    */
    ...
    function display_widget($widget,  $instance = false, $args = array('before_widget' => '<ul class="primary-menu"><li class="widget">','after_widget' => '</li></ul>', 'before_title' => '<h3 class="widgettitle">','after_title' => '</h3>')) 
    {
        $widget_name = $widget;
